<template>
  <div class="con-box">
    ...
    <div class="con-win-title">广告机：
      <Select v-model="data.criusSN" style="width:280px" class="con-maleft">
      ...
      </Select>播放时间：<el-date-picker class="con-maright date-pocker-width" prefix-icon="el-icon-date"
        ...
        节目名称：
        <el-input size="small" v-model="data.showName" placeholder="请输入" style="width: 180px"></el-input>
