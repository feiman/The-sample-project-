<template>
  <div
    ...
    :class="{
      ...
      dragging: dragging,
      resizing: resizing,
      ['selNameIndex'+selNameIndex]:true
    }" 
...
export default {
  ...
  methods: {
    reviewDimensions: function () {
      ...
      this.$emit('resizing', this.left, this.top, this.width, this.height,null,this.selNameIndex)
    },
    elmDown: function (e) {
      ...
      if (!this.enabled) {
          ...
          this.$emit('activated',this.selNameIndex);
    ...
    handleMove: function (e) {
      ...
      if (this.resizing) {
        ...
        var drageNode = e.target.parentNode.querySelector('.drag');
        if (drageNode) {
           this.$emit('resizing', this.left, this.top, this.width, this.height,drageNode.id,this.selNameIndex);
        }else{
        ...
        this.$emit('dragging', this.left, this.top , e.target.id?e.target.id:null,this.selNameIndex)
