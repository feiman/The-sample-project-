...
(function() {
  ...
  window.UMEDITOR_CONFIG = {
    ...
    //图片上传配置区
    imageUrl: "/criussell/sell/show/upfile", //图片上传提交地址  criussell/sell/show/upfile URL+"jsp/imageUp.jsp"
    imagePath: URL + "", //图片修正地址，引用了fixedImagePath,如有特殊需求，可自行配置 URL + jsp/"
    ...
    // ,initialFrameWidth:1400 //初始化编辑器宽度,默认500
    initialFrameHeight:406,  //初始化编辑器高度,默认500
