...
//                }
        ...
        callback: function (editor, $w, url, state) {
            if (state) {
                //显示图片计数+1   // editor.options.imagePath + url
                Upload.showCount++;
    ...
    var Upload = {
        ...
        uploadComplete: function(r){
            ...
            {"success":true,"msg":"上传成功","code":0,"data":{"original":"FkUUsW9e8yUIv8lLxDD-hqMYoaiP","name":"FkUUsW9e8yUIv8lLxDD-hqMYoaiP","url":"http://oz6haf75u.bkt.clouddn.com/FkUUsW9e8yUIv8lLxDD-hqMYoaiP"}}
            </pre>
            ...
            */
            try{
                ...
                console.log(json)
                Base.callback(me.editor, me.dialog, json.data.url, json.success);
            }catch (e){
